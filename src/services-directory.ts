...
export const BUNDLED_SERVICES: DirectoryService[] = [
  ...
  { id: "web-wallet", name: "Web Wallet", description: "Browser wallet for everyday ZKAS. Web keys are less protected than local custody.", categories: ["store", "use"], status: "Live", tags: ["Web", "Less secure"], action: "Open web wallet", href: "https://wallet.zkas.info", icon: "wallet" },
  ...
  { id: "community", name: "Community", description: "Get help, follow updates and talk with ZKAS users.", categories: ["use", "build"], status: "Open", tags: ["Discord", "X", "Support"], action: "Open Discord", href: "https://discord.gg/jysMS4XNFT", icon: "users", secondary: [{ label: "X", href: "https://x.com/ZKas_X" }] },
];
